# Project Test - Proje Tanımı / Project Definition
...
Bu belge **Project Test** projesinin amacını, hedeflerini ve kapsamını tanımlar.
...
This document defines the purpose, goals, and scope of **Project Test** project.
